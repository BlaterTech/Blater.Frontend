...
public class BrowserViewportObserverService(IBrowserViewportService browserViewportService) : IBrowserViewportObserverService
{
    ...
    public Typo Title { get; set; }
    public Typo SubTitle { get; set; }
