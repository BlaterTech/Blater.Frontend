    ...
    public MudTheme GetMudTheme()
    {
        ...
        if (themePaletteDark != null)
        {
            theme.PaletteDark = new PaletteDark
            {
                ...
                BackgroundGray = themePaletteDark.BackgroundGray ?? defaultTheme.PaletteDark.BackgroundGray,
                ...
                SecondaryContrastText = themePaletteDark.SecondaryContrastText ?? defaultTheme.PaletteDark.SecondaryContrastText,
            };
        }
        ...
        if (themePaletteLight != null)
        {
            theme.PaletteLight = new PaletteLight
            {
                ...
                BackgroundGray = themePaletteLight.BackgroundGray ?? defaultTheme.PaletteLight.BackgroundGray,
                ...
                SecondaryContrastText = themePaletteLight.SecondaryContrastText ?? defaultTheme.PaletteLight.SecondaryContrastText,
            };
        }
