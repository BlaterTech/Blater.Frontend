...
### AutoSystem.Frontend.SourceGenerator
...
### AutoSystem.Frontend.SourceGenerator.Sample

A project that references source generators. Note the parameters of `ProjectReference`
in [AutoSystem.Frontend.SourceGenerator.Sample.csproj](../AutoSystem.Frontend.SourceGenerator.Sample/AutoSystem.Frontend.SourceGenerator.Sample.csproj),
they make sure that the project is referenced as a set of source generators.

### AutoSystem.Frontend.SourceGenerator.Tests
